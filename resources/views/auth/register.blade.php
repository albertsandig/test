                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="userfullname" class="col-md-4 col-form-label text-md-right">{{ __('Full Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-md-4 col-form-label text-md-right">{{ __('Service Area') }}</label>

                            <div class="col-md-6">
                                <select id="service_area" type="text" class="form-control @error('service_area') is-invalid @enderror" name="service_area" value="{{ old('service_area') }}" required autocomplete="service_area">
                                    @foreach($serviceAreas as $serviceArea)
                                        <option value="{{ $serviceArea->code }}">{{ $serviceArea->name }}</option>
                                    @endforeach
                                </select>
                                @error('service_area')
                                    <span class="invalid-feedback" role="alert">
